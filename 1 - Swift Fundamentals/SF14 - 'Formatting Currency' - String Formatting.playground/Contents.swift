...
func formatAsDollars(_ amount: Float) -> String {
    return String(format: "$%.2f", amount)
}

print(formatAsDollars(39.99))
print(formatAsDollars(3))
print(formatAsDollars(3.1))


import Foundation

func formatAsDollarsAlt(_ amount: Float) -> String {
...
func formatAsYen(_ amount: Float) -> String {
    let conversionRate: Float = 148.52
    let yenAmount = amount * conversionRate
    // converstion $1 USD = $148.52 YEN
    ...
    return formatter.string(from: NSNumber(value: yenAmount)) ?? "Y0.00"
}

print(formatAsDollars(39.99))
print(formatAsDollarsAlt(39.99))
print(formatAsYen(39.99))
