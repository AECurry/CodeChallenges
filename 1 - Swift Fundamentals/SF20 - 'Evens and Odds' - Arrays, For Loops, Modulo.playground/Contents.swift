...
func printEvensAndOdds(numbers: [Int]) {
...
printEvensAndOdds(numbers: sampleArray)

func printEvensAndOddsInRange(min: Int, max: Int) {
...
printEvensAndOddsInRange(min: 10, max: 13)
