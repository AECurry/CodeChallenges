...
func heronArea(a: Double, b: Double, c: Double) -> String {
    if a + b <= c || a + c <= b || b + c <= a {
        return "Error: These sides do not form a valid triangle."
...
print(heronArea(a: 4, b: 13, c: 15))
print(heronArea(a: 2, b: 2, c: 10))
